...
export default class ApplicantForm extends Component {
  ...
  render() {
    ...
    switch (type) {
      case 'edit':
        disabled = ''
        product_name = <select className='applicant-form-dropdown' name='product_id' defaultValue={applicant.product_id} disabled={disabled} onChange={this.onProductIdChange}>
                         { Object.keys(products).map(id => 
                             <option key={id} value={id}>{products[id].name}</option>
                         )}
                       </select>
        product_detail = <select className='applicant-form-dropdown' name='product_detail_id' defaultValue={applicant.product_detail_id} disabled={disabled}>
        ...
        <div className='col-md-6 col-md-offset-3 col-xs-8 col-xs-offset-2 applicant-form'>
          ...
          <form ref='form'>
            <div className='col-xs-6'>
              ...
              <select className='applicant-form-dropdown' name='grade' defaultValue={applicant.grade} disabled={disabled}>
            ...
            <div className='col-xs-6'>
              ...
              <select className='applicant-form-dropdown' name='gender' defaultValue={applicant.gender} disabled={disabled}>
              ...
              <select className='applicant-form-dropdown' name='food_preference' defaultValue={applicant.food_preference} disabled={disabled}>
